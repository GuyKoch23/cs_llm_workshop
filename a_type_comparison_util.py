...
def compare_answers_chatgpt(promise_answer, hypothesis_answer):
    query = f"""
            ...
            | Approach Explanation  | How well does the hypothesis explain the reasoning compared to the promise?    | 1–10       | Explanation of clarity, completeness, and alignment with the promise. |
            | Correctness           | Is the hypothesis logically accurate and aligned with the promise?             | 1–10       | Explanation of correctness in implementation, logic, and problem-solving approach. |
            ...
            "ApproachExplanation":
                "score": <1-10>,
                "notes": "Explanation of how well the hypothesis explains the reasoning compared to the promise."
            ,
            "Correctness":
                "score": <1-10>,
